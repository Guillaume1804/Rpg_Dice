      ...
      >
        ...
        >
          <Ionicons
            ...
            size={15}
            color={
              disabled ? "rgba(255,255,255,0.36)" : "rgba(255,255,255,0.78)"
            }
          />
        </View>
  ...
  return (
    <>
      ...
      <ContextSelectorModal
        ...
        subtitle="Choisis le personnage dont les Mains sauvegardées seront affichées."
        emptyLabel="Aucun profil disponible pour cette table."
        options={profiles}
        selectedId={selectedProfileId}
        getMeta={(profile) =>
          typeof profile.actionCount === "number"
            ? `${profile.actionCount} Main${profile.actionCount > 1 ? "s" : ""}`
            : "Profil disponible"
        }
