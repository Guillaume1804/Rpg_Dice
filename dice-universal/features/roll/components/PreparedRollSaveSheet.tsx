    ...
    return (
        <Pressable
            ...
            style={({ pressed }) => ({
                ...
                borderColor,
                backgroundColor:
                    pressed && !disabled ? premium.colors.surface.pressed : backgroundColor,
                paddingVertical: 10,
    ...
    return (
        <Pressable
            ...
            style={({ pressed }) => ({
                ...
                transform: [{ scale: pressed && !disabled ? premium.animation.pressScale : 1 }],
            })}
        >
            <Text
                style={{
    ...
    return (
        ...
        >
                                ...
                                {loadingTargets ? (
                                    ...
                                    availableTargets.map((entry) => (
                                        <OptionCard
                                            ...
                                            description={`${entry.profiles.length} profil${entry.profiles.length > 1 ? "s" : ""
                                                }`}
            ...
            {source === "action_draft" && actionMode === "copy_name" ? (
                <View style={{ gap: premium.spacing.md }}>
                    <View>
                        <FieldLabel>Nom de la nouvelle action</FieldLabel>
                        <SaveInput
                            value={copyName}
